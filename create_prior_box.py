...
box_configs = [
    {'layer_width': 28, 'layer_height': 28, 'num_prior': 3, 'min_size':  22.0,
     'max_size': None, 'aspect_ratios': [1.0, 2.0, 1/2.0]},
    {'layer_width': 14, 'layer_height': 14, 'num_prior': 6, 'min_size':  44.0,
     'max_size': 88.0, 'aspect_ratios': [1.0, 1.0, 2.0, 1/2.0, 3.0, 1/3.0]},
    {'layer_width': 7, 'layer_height': 7, 'num_prior': 6, 'min_size': 88.0,
     'max_size': 130.0, 'aspect_ratios': [1.0, 1.0, 2.0, 1/2.0, 3.0, 1/3.0]},
    {'layer_width':  4, 'layer_height':  4, 'num_prior': 6, 'min_size': 130.0,
     'max_size': 160.0, 'aspect_ratios': [1.0, 1.0, 2.0, 1/2.0, 3.0, 1/3.0]},
    {'layer_width':  2, 'layer_height':  2, 'num_prior': 6, 'min_size': 160.0,
     'max_size': 200.0, 'aspect_ratios': [1.0, 1.0, 2.0, 1/2.0, 3.0, 1/3.0]},
    {'layer_width':  1, 'layer_height':  1, 'num_prior': 6, 'min_size': 200.0,
     'max_size': 250.0, 'aspect_ratios': [1.0, 1.0, 2.0, 1/2.0, 3.0, 1/3.0]},
]
...
if __name__ == "__main__":
    ...
    with open('prior_boxes_ssd224.pkl', mode='wb') as f:
        pickle.dump(boxes_paras, f)
    priors1 = pickle.load(open('prior_boxes_ssd224.pkl', 'rb'))
    priors2 = pickle.load(open('prior_boxes_ssd224.pkl', 'rb'))
