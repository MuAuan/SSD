...
def SSD(input_shape, num_classes):
    ...
    #conv4_0 = Conv2DTranspose(512, (2, 2), padding="valid", name='conv4_0', activation='relu')(pool3) #for VGG16,19,Resnet50
    conv4_0 = Conv2DTranspose(512, (4, 4), padding="valid", name='conv4_inceptionv3', activation='relu')(pool3) #for inceptionV3
