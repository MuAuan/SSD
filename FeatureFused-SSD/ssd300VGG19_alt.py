...
def SSD(input_shape, num_classes):
    ...
    vgg19_input_shape = (input_shape[1], input_shape[0], 3)


    net = {}
    input = Input(input_shape)
    #vgg16 = VGG16(input_shape=vgg16_input_shape, include_top=False, weights='imagenet')
    vgg19 = VGG19(input_shape=vgg19_input_shape, include_top=False, weights='imagenet')
    ...
    conv4_0 = Conv2DTranspose(128, 2, 2, activation='relu',   border_mode='valid')(pool3)
